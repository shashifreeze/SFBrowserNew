...
public class HisTouch implements RecyclerView.OnItemTouchListener{
    GestureDetector gestureDetector;
    private ClickListener clickListener;

    public HisTouch(Context context,final RecyclerView recyclerView,final ClickListener clickListener) {
